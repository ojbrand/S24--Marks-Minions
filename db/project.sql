...
(5, 'Kelsey Johnson', 'Nature lover hiking through scenic trails.', 'vchapman@example.net', '+1-941-566-5171', 4),
...
(8, 'Patrick Brewer', 'Fashionista staying ahead of the latest trends.', 'lgray@example.org', '+1-333-290-5122', 10),
(9, 'Cindy Clark', 'History buff fascinated by ancient civilizations.', 'jpierce@example.com', '384-378-3051', 11),
(10, 'Sarah Fields', 'Animal lover advocating for pet adoption.', 'michelle44@example.org', '898.480.1108', 12),
(11, 'Alan Cherry', 'Entrepreneur building dreams from the ground up.', 'james05@example.net', '001-972-934-8592', 8),
(12, 'Courtney Greene', 'Yoga practitioner finding zen in daily practice.', 'valdezamber@example.net', '533.373.1189', 7),
(13, 'Kimberly Anderson', 'Film buff with a passion for classic cinema.', 'perezstephanie@example.com', '001-392-520-6279', 10),
(14, 'Brenda Davis', 'DIY enthusiast creating unique crafts and projects.', 'keith95@example.org', '570.920.1073', 2),
(15, 'Stephanie Chen', 'Environmental activist promoting sustainable living.', 'kenneth63@example.com', '231-771-3822', 1),
(16, 'Mike Hammond', 'Fitness instructor inspiring others to lead healthier lives.', 'thomas03@example.com', '+1-726-506-2203', 3),
(17, 'Thomas Arnold', 'Travel enthusiast exploring cultures around the globe.', 'michaelramos@example.net', '880.946.2311', 4),
(18, 'Chelsea Collins', 'Sports fan cheering for the home team.', 'christopher21@example.org', '(986)920-6276', 5),
(19, 'Melissa Bush', 'Aspiring writer crafting stories that resonate.', 'lfernandez@example.org', '552.258.4070', 6),
(20, 'Frank Chang', 'Tech-savvy gamer mastering virtual worlds.', 'vshaw@example.net', '4573348201', 8),
(21, 'Matthew Edwards', 'Art collector with an eye for creativity.', 'waltervelez@example.com', '561-581-2022', 7),
(22, 'Gregory Kemp', 'Parent juggling work and family with love.', 'donaldschmidt@example.org', '001-385-960-7915', 11),
(23, 'Michele Copeland', 'Coffee connoisseur seeking the perfect brew.', 'mark71@example.org', '474-395-5560', 12),
(24, 'Kerry Pearson', 'Musician creating melodies that move the soul.', 'kristen81@example.com', '717.450.9591', 1),
(25, 'Johnathan Mccoy', 'Fitness coach empowering clients to reach their goals.', 'hernandezisaac@example.com', '(879)877-2345', 4),
(26, 'Michael Morris', 'History teacher educating minds one lesson at a time.', 'caitlin60@example.net', '001-384-233-8684', 9),
(27, 'Erin Brooks', 'Animal rights advocate fighting for furry friends.', 'michael35@example.com', '+1-567-749-2051', 5),
(28, 'Amanda Marquez', 'Entrepreneurial spirit with big dreams and determination.', 'fischercrystal@example.net', '001-560-545-9981', 7),
(29, 'Amy Schultz', 'Nature photographer capturing beauty in simplicity.', 'gnolan@example.org', '551-453-7756', 6),
...
(34, 'Cody Moreno', 'Community activist making positive changes in society.', 'jenniferwebster@example.net', '404-245-6727', 2),
(35, 'Andrew Campbell', 'Fitness blogger inspiring healthy lifestyles online.', 'andrea67@example.com', '509-853-6643', 2),
(36, 'John Reynolds', 'Vintage collector preserving history through antiques.', 'david91@example.com', '(581)648-8122', 3),
(37, 'Mr. Dylan Jones MD', 'Wellness coach promoting holistic health and mindfulness.', 'mgreen@example.com', '299-693-3792', 4),
(38, 'Katherine Mcclain', 'Social media influencer sharing lifes adventures.', 'kenttina@example.net', '(397)453-4490', 5),
(39, 'Andrew Morrison', 'Startup founder disrupting industries with innovation.', 'janet45@example.com', '651-531-5112', 6),
(40, 'Joseph Perez', 'Language enthusiast learning new tongues and cultures.', 'tross@example.org', '685-704-4201', 7),
(41, 'Pamela Gonzalez', 'Finance expert helping others achieve financial freedom.', 'brentcasey@example.com', '4335947081', 8),
(42, 'Rachel Mitchell', 'Educator shaping young minds for a brighter future.', 'josephbest@example.org', '+1-990-767-9937', 12),
(43, 'Anthony Grimes', 'Gardening enthusiast nurturing plants and green spaces.', 'ksalinas@example.org', '202-706-4891', 11),
(44, 'Sabrina Reeves', 'Podcast host discussing topics that matter.', 'chunt@example.com', '979-820-7365', 10),
(45, 'Jose Dudley', 'Minimalist embracing simplicity and mindful living.', 'michelleduncan@example.com', '9418749592', 9),
(46, 'Amy Romero', 'Dreamer with big aspirations and endless possibilities.', 'brandon59@example.org', '001-388-5204', 8),
(47, 'Kendra Lopez', 'Volunteer making a difference in the community.', 'nguyenlisa@example.com', '(653)887-3790', 12),
(48, 'Jesus Barker', 'Home chef experimenting with recipes and flavors.', 'marialeach@example.net', '212.861.6837', 7),
(49, 'Ashley Briggs DDS', 'Interior designer creating spaces that inspire.', 'qkey@example.org', '+1-539-292-3050', 6),
(50, 'Justin Anderson', 'Tech entrepreneur bridging gaps with digital solutions.', 'fullereric@example.net', '(795)510-3704', 5),
...
(53, 'Joseph Fischer', 'Vintage fashion lover with a retro flair.', 'lwilson@example.com', '(298)832-7880', 2),
(54, 'Monica Clark', 'Motivational speaker empowering audiences worldwide.', 'nbutler@example.org', '(309)294-2658', 3),
(55, 'Kristine Martinez', 'Freelance writer crafting words that resonate.', 'nolandeborah@example.org', '511-389-3962', 4),
...
(58, 'Bianca Woodward', 'Art curator showcasing talent and creativity.', 'david56@example.net', '764-820-9534', 2),
(59, 'Frederick Novak', 'Social justice advocate fighting for equality.', 'samanthasnyder@example.com', '(345)385-6971', 3),
(60, 'Lauren Hoover', 'Digital artist creating digital masterpieces.', 'nguyenconnie@example.org', '447-447-9385', 7),
(61, 'Sandra Myers', 'Health coach promoting holistic wellness.', 'scottoliver@example.com', '206.541.1772', 8),
(62, 'Robert Kennedy', 'Historian preserving the past for future generations.', 'barrettmichael@example.org', '357.736.3558', 9),
(63, 'Mark Long', 'Creative director shaping visual narratives.', 'mboone@example.net', '725-694-7850', 5),
(64, 'Walter Farmer', 'Animal rescuer providing love and care to furry friends.', 'kylelee@example.net', '2337706035', 4),
(65, 'Crystal Miller', 'Political activist advocating for change.', 'ahayden@example.com', '719-997-1810', 9),
(66, 'Trevor Nguyen', 'Music producer creating beats that move the soul.', 'jamesgonzalez@example.org', '636.776.6595', 10),
(67, 'Brent Yang', 'Startup enthusiast with a vision for innovation.', 'gabrielrosario@example.com', '207.291.2419', 11),
(68, 'Patrick Cox', 'Lifestyle blogger sharing insights on living well.', 'eduardorodriguez@example.net', '(634)942-0736', 2),
(69, 'Heidi Jordan', 'Fashion designer blending style and sustainability.', 'bobbyparker@example.net', '001-660-957-9159', 3),
(70, 'Daniel Carey', 'Life coach guiding others to find their purpose.', 'dustinphillips@example.com', '001-752-805-9453', 3),
(71, 'Christopher Jackson', 'Tech blogger exploring the latest tech trends.', 'andrew40@example.com', '001-271-594-1219', 10),
(72, 'Charles Powell', 'Fitness competitor pushing limits for success.', 'christinemclaughlin@example.com', '+1-417-818-4305', 12),
(73, 'Heather Simmons', 'Vintage car enthusiast restoring classic automobiles.', 'walkerdavid@example.com', '587-342-2386', 8),
(74, 'Jacqueline Kaufman', 'Motivational author inspiring readers with stories.', 'collinschristine@example.net', '655-558-6917', 8),
(75, 'Andrew Ross', 'Hiking enthusiast conquering trails and peaks.', 'victoriapaul@example.net', '+1-641-473-7360', 7),
(76, 'Daniel Elliott', 'Gymnastics coach training athletes for success.', 'bharris@example.net', '287-356-2507', 6),
...
INSERT INTO media (mediaID, title, mediaType, rating, genre, mood) VALUES 
(41, 'Shadows in the Mist', 2, 41, 2, 1),
(42, 'Whispering Wind', 2, 42, 4, 2),
(43, 'Echoes of Tomorrow', 2, 43, 4, 3),
(44, 'Dancing with Fire', 2, 44, 5, 4),
(45, 'Midnight Serenade', 2, 45, 2, 5),
(46, 'Secrets of the Heart', 2, 46, 4, 6),
(47, 'Lost in Time', 2, 47, 5, 7),
(48, 'Reflections in Water', 2, 48, 1, 8),
(49, 'Beyond the Horizon', 2, 49, 2, 9),
(50, 'Starlight Symphony', 2, 50, 1, 10),
(51, 'Journey to Infinity', 2, 51, 3, 11),
(52, 'Dreams of Destiny', 2, 52, 1, 12),
(53, 'Enchanted Garden', 2, 53, 5, 1),
(54, 'Tales of Twilight', 2, 54, 2, 2),
(55, 'Whispers in the Wind', 2, 55, 4, 3),
(56, 'Echoes of Eternity', 2, 56, 5, 4),
(57, 'Midnight Magic', 2, 57, 3, 5),
(58, 'Shattered Dreams', 2, 58, 1, 6),
(59, 'Dancing with Shadows', 2, 59, 1, 7),
(60, 'Secrets of the Past', 2, 60, 4, 8),
(1, 'The Monkey King', 3, 1, 3, 9),
(2, 'The Yellow Mile', 3, 2, 2, 10),
(3, 'Silence of the Children', 3, 3, 2, 11),
(4, 'The Grand Wizard', 3, 4, 5, 12),
(5, 'Starlight Serenade', 3, 5, 5, 1),
(6, 'Midnights Symphony', 3, 6, 4, 2),
(7, 'Echoes of the Past', 3, 7, 5, 3),
(8, 'Dreamscape', 3, 8, 3, 4),
(9, 'Velvet Shadows', 3, 9, 5, 5),
(10, 'The Phoenix Rises', 3, 10, 5, 6),
(11, 'Ocean of Stars', 3, 11, 4, 7),
(12, 'Chasing Shadows', 3, 12, 1, 8),
(13, 'Whispers in the Dark', 3, 13, 3, 9),
(14, 'The Enigma Chronicles', 3, 14, 5, 10),
(15, 'Journey to Eternity', 3, 15, 5, 11),
(16, 'Echoes of Destiny', 3, 16, 5, 12),
(17, 'Dance of the Fallen', 3, 17, 2, 1),
(18, 'Symphony of Secrets', 3, 18, 3, 2),
(19, 'The Legend of Ashen Falls', 3, 19, 3, 3),
(20, 'Twilight Reverie', 3, 20, 4, 4),
(21, 'Starlight Symphony', 1, 21, 2, 5),
(22, 'Neon Dreams', 1, 22, 2, 6),
(23, 'City of Echoes', 1, 23, 3, 7),
(24, 'Midnight Melodies', 1, 24, 4, 8),
(25, 'Soul Serenade', 1, 25, 4, 9),
(26, 'Whispers of the Heart', 1, 26, 3, 10),
(27, 'Celestial Harmonies', 1, 27, 3, 11),
(28, 'Electric Euphoria', 1, 28, 4, 12),
(29, 'Moonlit Melancholy', 1, 29, 3, 1),
(30, 'Radiant Rhythms', 1, 30, 5, 2),
(31, 'Vibrant Visions', 1, 31, 4, 3),
(32, 'Dreams Unfold', 1, 32, 4, 4),
(33, 'Sirens Song', 1, 33, 3, 5),
(34, 'Twilight Tango', 1, 34, 4, 6),
(35, 'Melodic Mirage', 1, 35, 3, 7),
(36, 'Echoes in the Void', 1, 36, 3, 8),
(37, 'Harmony Haven', 1, 37, 3, 9),
(38, 'Stardust Sonata', 1, 38, 1, 10),
(39, 'Cosmic Cadence', 1, 39, 2, 11),
(40, 'Aurora Anthem', 1, 40, 1, 12);
...
INSERT INTO log (logID, mediaID, review, Rating, userID, favorite) VALUES
(60, 60, 'As a fan of action-packed films, I was thrilled by the intense sequences and adrenaline-pumping stunts in this movie. A must-watch for action lovers!', 1, 16, true),
...
(50, 'My Reflections', 'Today was a whirlwind of emotions, from moments of joy to deep reflection.', 7, '2024-01-22 20:15:19.897855'),
...
(50, 'Read 50 books in a year.', 1, '2024-12-17'),
(1, 'Learn to play the guitar.', 1, '2025-01-17'),
